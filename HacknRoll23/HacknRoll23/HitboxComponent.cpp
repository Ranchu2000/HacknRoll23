...
HitboxComponent::HitboxComponent(sf::Sprite& sprite, float offset_x, float offset_y,float width, float height) : sprite(sprite), offsetX(offset_x), offsetY(offset_y)
{
	...
	this->hitbox.setOutlineColor(sf::Color::Red); //visible hitbox
