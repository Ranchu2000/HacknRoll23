...
//Mutators
void MovementComponent::increaseMaxVelocity(int levels)
{
	this->maxVelocity += levels * PLAYER_UPGRADE_SPEED; 
}

void MovementComponent::setMaxVelocity(float velocity)
{
...
void MovementComponent::update(const float& dt)
{
	...
	this->sprite.move(this->velocity * dt); //move entity after all updates
}